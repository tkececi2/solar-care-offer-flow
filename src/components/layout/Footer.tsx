    ...
    <footer className="bg-primary text-primary-foreground mt-16">
      <div className="container mx-auto px-4 py-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">GESBakım</h3>
            <p className="mb-4">
              Güneş enerji santralleriniz için profesyonel işletme ve bakım hizmetleri sunuyoruz.
            </p>
            <div className="flex space-x-4">
              {/* Sosyal medya ikonları için yer tutucu */}
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center">
                ...
                <span>+90 212 555 4433</span>
              </li>
              <li className="flex items-center">
                <Mail className="w-5 h-5 mr-2" />
                <span>info@gesbakım.com</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="border-t border-primary-foreground/20 bg-primary/80">
        <div className="container mx-auto px-4 py-4 flex flex-col md:flex-row items-center justify-between text-sm">
          <p>&copy; {new Date().getFullYear()} GESBakım. Tüm hakları saklıdır.</p>
